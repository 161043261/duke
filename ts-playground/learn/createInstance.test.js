...
test('Create instance by __proto__', () => {
  const obj = {a: 1};
...
test('Create instance by function', () => {
  function ArrWrapper() {
    this.arr = [];
  }
...
test('Create instance by Object.create()', () => {
  const grandpa = {v: 1};
...
test('Create instance by class (recommend)', () => {
  class Rectangle {
...
test('Create instance by Object.setPrototypeOf()', () => {
  const base = {
    val: 1, func() {
      return 2;
    },
...
test('Create instance by Object.prototype.__proto__', () => {
  const son = {age: 1};
